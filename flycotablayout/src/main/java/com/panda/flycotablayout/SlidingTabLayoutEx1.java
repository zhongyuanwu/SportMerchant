 ...
 */
public class SlidingTabLayoutEx1 extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public SlidingTabLayoutEx1(Context context) {
        this(context, null, 0);
    }

    public SlidingTabLayoutEx1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingTabLayoutEx1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mAlpha = ta.getFloat(R.styleable.SlidingTabLayout_tl_alpha, 1.0f);
        ...
        mSubTextsize = ta.getDimension(R.styleable.SlidingTabLayout_tl_sub_textsize, sp2px(13f));
        mSubTextSelectColor = ta.getColor(R.styleable.SlidingTabLayout_tl_sub_textSelectColor, Color.parseColor("#FF414655"));
        mSubTextUnselectColor = ta.getColor(R.styleable.SlidingTabLayout_tl_sub_textUnselectColor, Color.parseColor("#98A7B5"));
        mSubTextVisible = ta.getInt(R.styleable.SlidingTabLayout_tl_sub_textVisible, 1);
     ...
     * 设置titles
     */
    public void setTitles(ArrayList<TabEntity> tabEntitys) {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.layout_tab_top_ex, null);
            addTab(i, mTabEntitys.get(i), tabView);
        }

        updateTabStyles();
    }

    public void addNewTab(TabEntity tabEntity) {
        View tabView = View.inflate(mContext, R.layout.layout_tab_top_ex, null);
        if (mTabEntitys != null) {
            mTabEntitys.add(tabEntity);
        }

        addTab(mTabCount, tabEntity, tabView);
        this.mTabCount = mTabEntitys.size();
     ...
     * 创建并添加tab
     */
    private void addTab(final int position, TabEntity tabEntity, View tabView) {
        TextView tv_tab_title = tabView.findViewById(R.id.tv_tab_title);
        TextView tv_tab_sbutitle = tabView.findViewById(R.id.tv_tab_sbutitle);
        if (tv_tab_title != null) {
            tv_tab_title.setText(tabEntity.getTabTitle());
            tv_tab_sbutitle.setText("(" + tabEntity.count + ")");
        }
    ...
    public void updateSubTitle() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            TextView tv_tab_sbutitle = v.findViewById(R.id.tv_tab_sbutitle);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                tv_tab_sbutitle.setVisibility(mSubTextVisible == 1 ? VISIBLE : GONE);

                tv_tab_title.setTextColor(i == mCurrentTab ? mTextSelectColor : mTextUnselectColor);
                tv_tab_title.setAlpha(i == mCurrentTab ? 1.0f : mAlpha);
                ...
                tv_tab_sbutitle.setTextColor(i == mCurrentTab ? mSubTextSelectColor : mSubTextUnselectColor);
                tv_tab_sbutitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, mSubTextsize);
            }
        }
    }
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tv_tab_sbutitle.setTextColor(isSelect ? mSubTextSelectColor : mSubTextUnselectColor);
                iv_tab_icon.setImageResource(isSelect ? mTabEntitys.get(i).getTabSelectedIcon() : mTabEntitys.get(i).getTabUnselectedIcon());
                tab_title.setAlpha(isSelect ? 1.0f : mAlpha);
    ...
    public void setSubTextSelectColor(int textSelectColor) {
        this.mSubTextSelectColor = textSelectColor;
        updateTabStyles();
    }

    public void setSubTextUnselectColor(int textUnselectColor) {
        this.mSubTextUnselectColor = textUnselectColor;
        updateTabStyles();
    }
    ...
    public void setTextSubTextVisible(int subTextVisible) {
        this.mSubTextVisible = subTextVisible;
        updateTabStyles();
    }
    ...
    public void showMsg(int position, int num) {
        ...
        TextView tipView = tabView.findViewById(R.id.tv_tab_sbutitle);
        if (tipView != null) {
            tipView.setText("(" + num + ")");
        }
    }
