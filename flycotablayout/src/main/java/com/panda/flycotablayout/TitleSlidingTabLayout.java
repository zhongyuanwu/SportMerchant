 ...
 */
public class TitleSlidingTabLayout extends HorizontalScrollView {
    ...
    public TitleSlidingTabLayout(Context context) {
        this(context, null, 0);
    }

    public TitleSlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TitleSlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * 设置titles数据
     */
    public void setTitles(ArrayList<TabEntity> tabEntities) {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            CharSequence pageTitle = mTabEntitys.get(i).title;
    ...
    public void addNewTab(TabEntity tabEntity) {
        ...
        CharSequence pageTitle = mTabEntitys.get(mTabCount).title;
