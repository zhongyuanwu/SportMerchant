...
import com.panda.flycotablayout.utils.FragmentChangeManager;
 ...
 */
public class CommonTabLayoutEx extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public CommonTabLayoutEx(Context context) {
        this(context, null, 0);
    }

    public CommonTabLayoutEx(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CommonTabLayoutEx(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mSubTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_sub_textsize, sp2px(13f));
        mSubTextSelectColor = ta.getColor(R.styleable.CommonTabLayout_tl_sub_textSelectColor, Color.parseColor("#ffffff"));
        mSubTextUnselectColor = ta.getColor(R.styleable.CommonTabLayout_tl_sub_textUnselectColor, Color.parseColor("#AAffffff"));
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            TextView tv_tab_sbutitle = (TextView) tabView.findViewById(R.id.tv_tab_sbutitle);
